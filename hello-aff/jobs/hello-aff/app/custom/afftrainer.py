...
# in order to read from json file
...
class affTrainer(Executor):
    def __init__(
        ...
        self._train_dataset = CustomDataset(train_data, transform=train_transforms)
        self._train_loader = DataLoader(self._train_dataset, batch_size=8, shuffle=True)
